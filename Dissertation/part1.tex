\chapter{Обзор работ в области математического моделирования динамики лесного пожара и влияния взрыва на
...
Россия одна из стран мира, имеющая самые большие территории, покрытые лесом,
с огромным разнообразием его типов~\cite{gks_environmental_protection}.
Лесистость России -- 46,4 \%~\cite{gks_environmental_protection, federal_forest_agency},
при этом, начиная с 2015 года, территория, покрытая лесами, постепенно увеличивается, и к 2017 году
составила \num{1184,5} млн. \si{\hectare} с общим запасом древесины, 82,8 млрд. \si{\metre^3}.
...
\begin{equation}
    ...
    \begin{alignedat}{2}
    {\mathbf{N}}
        _{o1n}^{(j)} = \,{\sin} \phi\,n\!\left(n+1\right)
        {\sin}\theta\,
